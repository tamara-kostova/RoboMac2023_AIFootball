...
def decision(our_team, their_team, ball, your_side, half, time_left, our_score, their_score):
    ...
    for p in players:
        ...
        manager_decision[i]['alpha'] = get_angle_goal_keeper(player_x, player_y, ball_x, ball_y, your_side, force)[0]
        manager_decision[i]['force'] = get_angle_goal_keeper(player_x, player_y, ball_x, ball_y, your_side, force)[1]
